...
import { ScrollbarGeometry, ScrollbarPosition } from 'app/shared/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector: '[smartrScrollbar]',
    exportAs: 'smartrScrollbar'
})
export class SmartrScrollbarDirective implements OnChanges, OnInit, OnDestroy {
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_smartrScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() smartrScrollbar: boolean = true;
    @Input() smartrScrollbarOptions: PerfectScrollbar.Options;
    ...
    ngOnChanges(changes: SimpleChanges): void {
        // Enabled
        if ('smartrScrollbar' in changes) {
            // Interpret empty string as 'true'
            this.smartrScrollbar = coerceBooleanProperty(changes.smartrScrollbar.currentValue);

            // If enabled, init the directive
            if (this.smartrScrollbar) {
                this._init();
            }
        ...
        // Scrollbar options
        if ('smartrScrollbarOptions' in changes) {
            // Merge the options
            this._options = merge({}, this._options, changes.smartrScrollbarOptions.currentValue);
