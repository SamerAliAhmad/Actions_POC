...
namespace BLC
{
    public partial class BLC
    {
        ...
        public Stopwatch _Execution_Time_Primary_Authentication { get; set; }
        public Stopwatch _Execution_Time_OTP_Verification { get; set; }
        public Stopwatch _Execution_Time_Change_User_Forgotten_Password { get; set; }
        public Stopwatch _Execution_Time_Verify_Otp { get; set; }
        public Stopwatch _Execution_Time_Send_Otp { get; set; }
        public Stopwatch _Execution_Time_Edit_Otp_List { get; set; }
        public Stopwatch _Execution_Time_Get_Otp_By_USER_ID { get; set; }
        public Stopwatch _Execution_Time_Delete_Otp_By_USER_ID { get; set; }
        public Stopwatch _Execution_Time_Delete_Otp_By_OTP_ID { get; set; }
        #endregion
