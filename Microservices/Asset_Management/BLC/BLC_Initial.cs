...
namespace BLC
{
    ...
    public partial class BLC : IDisposable
    {
        ...
        {
            #region Body Section.
            OnPostEvent_Get_Asset_By_ASSET_ID_Adv += new PostEvent_Handler_Get_Asset_By_ASSET_ID_Adv(BLC_OnPostEvent_Get_Asset_By_ASSET_ID_Adv);
            #endregion
        }
        #endregion
        ...
        #region BLC_OnPostEvent_Get_Asset_By_ASSET_ID_Adv
        public void BLC_OnPostEvent_Get_Asset_By_ASSET_ID_Adv(ref Asset i_Result, Params_Get_Asset_By_ASSET_ID i_Params_Get_Asset_By_ASSET_ID)
        {
            i_Result.GLTF_URL = $"{Global.Assets_Endpoint}/{i_Result.GLTF_URL}";
        }
        #endregion
        #endregion
    }
