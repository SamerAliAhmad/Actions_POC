...
namespace BLC
{
    public partial class BLC
    {
        ...
        private Top_level _Top_level;
        private List<Top_level> _List_Top_level;
        ...
        private bool _Stop_Edit_Top_level_Execution;
        private bool _Stop_Delete_Top_level_Execution;
        ...
        public Top_level Get_Top_level_By_TOP_LEVEL_ID(Params_Get_Top_level_By_TOP_LEVEL_ID i_Params_Get_Top_level_By_TOP_LEVEL_ID)
        {
            Top_level oTop_level = null;
            var i_Params_Get_Top_level_By_TOP_LEVEL_ID_json = JsonConvert.SerializeObject(i_Params_Get_Top_level_By_TOP_LEVEL_ID);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Top_level_By_TOP_LEVEL_ID", i_Params_Get_Top_level_By_TOP_LEVEL_ID_json, false);
            }
            #region PreEvent_Get_Top_level_By_TOP_LEVEL_ID
            if (OnPreEvent_Get_Top_level_By_TOP_LEVEL_ID != null)
            {
                OnPreEvent_Get_Top_level_By_TOP_LEVEL_ID(i_Params_Get_Top_level_By_TOP_LEVEL_ID);
            }
            #endregion
            #region Body Section.
            DALC.Top_level oDBEntry = _AppContext.Get_Top_level_By_TOP_LEVEL_ID(i_Params_Get_Top_level_By_TOP_LEVEL_ID.TOP_LEVEL_ID);
            if (oDBEntry == null)
            {
                throw new BLC_Exception(Get_Message_Content(Enum_BR_Codes.BR_0001).Replace("%1", "Top_level").Replace("%2", i_Params_Get_Top_level_By_TOP_LEVEL_ID.TOP_LEVEL_ID.ToString()));
            }
            oTop_level = new Top_level();
            Props.Copy_Prop_Values(oDBEntry, oTop_level);
            #endregion
            #region PostEvent_Get_Top_level_By_TOP_LEVEL_ID
            if (OnPostEvent_Get_Top_level_By_TOP_LEVEL_ID != null)
            {
                OnPostEvent_Get_Top_level_By_TOP_LEVEL_ID(oTop_level, i_Params_Get_Top_level_By_TOP_LEVEL_ID);
            }
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Top_level_By_TOP_LEVEL_ID", i_Params_Get_Top_level_By_TOP_LEVEL_ID_json, false);
            }
            return oTop_level;
        }
        #endregion
        ...
        public List<Top_level> Get_Top_level_By_TOP_LEVEL_ID_List(Params_Get_Top_level_By_TOP_LEVEL_ID_List i_Params_Get_Top_level_By_TOP_LEVEL_ID_List)
        {
            List<Top_level> oList_Top_level = null;
            var i_Params_Get_Top_level_By_TOP_LEVEL_ID_List_json = JsonConvert.SerializeObject(i_Params_Get_Top_level_By_TOP_LEVEL_ID_List);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Top_level_By_TOP_LEVEL_ID_List", i_Params_Get_Top_level_By_TOP_LEVEL_ID_List_json, false);
            }
            #region PreEvent_Get_Top_level_By_TOP_LEVEL_ID_List
            if (OnPreEvent_Get_Top_level_By_TOP_LEVEL_ID_List != null)
            {
                OnPreEvent_Get_Top_level_By_TOP_LEVEL_ID_List(i_Params_Get_Top_level_By_TOP_LEVEL_ID_List);
            }
            #endregion
            #region Body Section.
            List<DALC.Top_level> oList_DBEntry = _AppContext.Get_Top_level_By_TOP_LEVEL_ID_List(i_Params_Get_Top_level_By_TOP_LEVEL_ID_List.TOP_LEVEL_ID_LIST);
            ...
            #endregion
            #region PostEvent_Get_Top_level_By_TOP_LEVEL_ID_List
            if (OnPostEvent_Get_Top_level_By_TOP_LEVEL_ID_List != null)
            {
                OnPostEvent_Get_Top_level_By_TOP_LEVEL_ID_List(oList_Top_level, i_Params_Get_Top_level_By_TOP_LEVEL_ID_List);
            }
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Top_level_By_TOP_LEVEL_ID_List", i_Params_Get_Top_level_By_TOP_LEVEL_ID_List_json, false);
            }
        ...
        public List<Top_level> Get_Top_level_By_OWNER_ID(Params_Get_Top_level_By_OWNER_ID i_Params_Get_Top_level_By_OWNER_ID)
        {
            List<Top_level> oList_Top_level = null;
            var i_Params_Get_Top_level_By_OWNER_ID_json = JsonConvert.SerializeObject(i_Params_Get_Top_level_By_OWNER_ID);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Top_level_By_OWNER_ID", i_Params_Get_Top_level_By_OWNER_ID_json, false);
            }
            #region Body Section.
            List<DALC.Top_level> oList_DBEntry = _AppContext.Get_Top_level_By_OWNER_ID(i_Params_Get_Top_level_By_OWNER_ID.OWNER_ID);
            if (oList_DBEntry != null)
            {
                oList_Top_level = new List<Top_level>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Top_level_By_OWNER_ID", i_Params_Get_Top_level_By_OWNER_ID_json, false);
            }
            return oList_Top_level;
        }
        #endregion
        #region Get_Top_level_By_OWNER_ID_IS_DELETED
        public List<Top_level> Get_Top_level_By_OWNER_ID_IS_DELETED(Params_Get_Top_level_By_OWNER_ID_IS_DELETED i_Params_Get_Top_level_By_OWNER_ID_IS_DELETED)
        {
            List<Top_level> oList_Top_level = null;
            var i_Params_Get_Top_level_By_OWNER_ID_IS_DELETED_json = JsonConvert.SerializeObject(i_Params_Get_Top_level_By_OWNER_ID_IS_DELETED);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Top_level_By_OWNER_ID_IS_DELETED", i_Params_Get_Top_level_By_OWNER_ID_IS_DELETED_json, false);
            }
            #region Body Section.
            List<DALC.Top_level> oList_DBEntry = _AppContext.Get_Top_level_By_OWNER_ID_IS_DELETED(i_Params_Get_Top_level_By_OWNER_ID_IS_DELETED.OWNER_ID, i_Params_Get_Top_level_By_OWNER_ID_IS_DELETED.IS_DELETED);
            if (oList_DBEntry != null)
            {
                oList_Top_level = new List<Top_level>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Top_level_By_OWNER_ID_IS_DELETED", i_Params_Get_Top_level_By_OWNER_ID_IS_DELETED_json, false);
            }
            return oList_Top_level;
        }
        #endregion
        ...
        public List<Top_level> Get_Top_level_By_Where(Params_Get_Top_level_By_Where i_Params_Get_Top_level_By_Where)
        {
            long? tmp_TOTAL_COUNT = 0;
            List<Top_level> oList_Top_level = null;
            var i_Params_Get_Top_level_By_Where_json = JsonConvert.SerializeObject(i_Params_Get_Top_level_By_Where);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Top_level_By_Where", i_Params_Get_Top_level_By_Where_json, false);
            }
            #region Body Section.
            if (i_Params_Get_Top_level_By_Where.OWNER_ID == null || i_Params_Get_Top_level_By_Where.OWNER_ID == 0)
            {
                i_Params_Get_Top_level_By_Where.OWNER_ID = this.oBLC_Initializer.Owner_ID;
            }
            if (i_Params_Get_Top_level_By_Where.OFFSET == null)
            {
                i_Params_Get_Top_level_By_Where.OFFSET = 0;
            }
            if (i_Params_Get_Top_level_By_Where.FETCH_NEXT == null || i_Params_Get_Top_level_By_Where.FETCH_NEXT == 0)
            {
                i_Params_Get_Top_level_By_Where.FETCH_NEXT = 1000000;
            }
            List<DALC.Top_level> oList_DBEntry = _AppContext.Get_Top_level_By_Where(i_Params_Get_Top_level_By_Where.NAME, i_Params_Get_Top_level_By_Where.LOCATION, i_Params_Get_Top_level_By_Where.IMAGE_URL, i_Params_Get_Top_level_By_Where.LOGO_URL, i_Params_Get_Top_level_By_Where.AREA_COLOR, i_Params_Get_Top_level_By_Where.BORDER_COLOR, i_Params_Get_Top_level_By_Where.STUDY_ZONE_NAME, i_Params_Get_Top_level_By_Where.OWNER_ID, i_Params_Get_Top_level_By_Where.OFFSET, i_Params_Get_Top_level_By_Where.FETCH_NEXT, ref tmp_TOTAL_COUNT);
            if (oList_DBEntry != null)
            {
                oList_Top_level = new List<Top_level>();
                if (oList_DBEntry.Count > 0)
            ...
            i_Params_Get_Top_level_By_Where.TOTAL_COUNT = tmp_TOTAL_COUNT;
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Top_level_By_Where", i_Params_Get_Top_level_By_Where_json, false);
            }
            return oList_Top_level;
        }
        #endregion
        ...
        public void Delete_Top_level(Params_Delete_Top_level i_Params_Delete_Top_level)
        {
            var i_Params_Delete_Top_level_json = JsonConvert.SerializeObject(i_Params_Delete_Top_level);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Top_level", i_Params_Delete_Top_level_json, false);
            }
            #region Body Section.
            try
            {
                Params_Get_Top_level_By_TOP_LEVEL_ID oParams_Get_Top_level_By_TOP_LEVEL_ID = new Params_Get_Top_level_By_TOP_LEVEL_ID
                {
                    TOP_LEVEL_ID = i_Params_Delete_Top_level.TOP_LEVEL_ID
                };
                _Top_level = Get_Top_level_By_TOP_LEVEL_ID(oParams_Get_Top_level_By_TOP_LEVEL_ID);
                if (_Top_level != null)
                {
                    if (_Stop_Delete_Top_level_Execution)
                    {
                        _Stop_Delete_Top_level_Execution = false;
                        return;
                    }
                    _AppContext.Delete_Top_level(i_Params_Delete_Top_level.TOP_LEVEL_ID);
                }
            }
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Top_level", i_Params_Delete_Top_level_json, false);
            }
        }
        #endregion
        ...
        public void Delete_Top_level_By_OWNER_ID(Params_Delete_Top_level_By_OWNER_ID i_Params_Delete_Top_level_By_OWNER_ID)
        {
            var i_Params_Delete_Top_level_By_OWNER_ID_json = JsonConvert.SerializeObject(i_Params_Delete_Top_level_By_OWNER_ID);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Top_level_By_OWNER_ID", i_Params_Delete_Top_level_By_OWNER_ID_json, false);
            }
            #region Body Section.
            try
            {
                ...
                {
                    OWNER_ID = i_Params_Delete_Top_level_By_OWNER_ID.OWNER_ID
                };
                _List_Top_level = Get_Top_level_By_OWNER_ID(oParams_Get_Top_level_By_OWNER_ID);
                if (_List_Top_level != null && _List_Top_level.Count > 0)
                {
                    if (_Stop_Delete_Top_level_Execution)
                    {
                        _Stop_Delete_Top_level_Execution = false;
                    ...
                    _AppContext.Delete_Top_level_By_OWNER_ID(i_Params_Delete_Top_level_By_OWNER_ID.OWNER_ID);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Top_level_By_OWNER_ID", i_Params_Delete_Top_level_By_OWNER_ID_json, false);
            }
        }
        #endregion
        #region Delete_Top_level_By_OWNER_ID_IS_DELETED
        public void Delete_Top_level_By_OWNER_ID_IS_DELETED(Params_Delete_Top_level_By_OWNER_ID_IS_DELETED i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED)
        {
            var i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED_json = JsonConvert.SerializeObject(i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Top_level_By_OWNER_ID_IS_DELETED", i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED_json, false);
            }
            #region Body Section.
            try
            {
                Params_Get_Top_level_By_OWNER_ID_IS_DELETED oParams_Get_Top_level_By_OWNER_ID_IS_DELETED = new Params_Get_Top_level_By_OWNER_ID_IS_DELETED
                {
                    OWNER_ID = i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED.OWNER_ID,
                    IS_DELETED = i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED.IS_DELETED
                };
                _List_Top_level = Get_Top_level_By_OWNER_ID_IS_DELETED(oParams_Get_Top_level_By_OWNER_ID_IS_DELETED);
                if (_List_Top_level != null && _List_Top_level.Count > 0)
                {
                    if (_Stop_Delete_Top_level_Execution)
                    {
                    ...
                    _AppContext.Delete_Top_level_By_OWNER_ID_IS_DELETED(i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED.OWNER_ID, i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED.IS_DELETED);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Top_level_By_OWNER_ID_IS_DELETED", i_Params_Delete_Top_level_By_OWNER_ID_IS_DELETED_json, false);
            }
        }
        #endregion
        ...
        public void Edit_Top_level(Top_level i_Top_level)
        {
            var i_Top_level_json = JsonConvert.SerializeObject(i_Top_level);

            Enum_Edit_Mode oEditMode_Flag = Enum_Edit_Mode.Update;
            if (i_Top_level.TOP_LEVEL_ID == -1)
            {
                oEditMode_Flag = Enum_Edit_Mode.Add;
            }
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Edit_Top_level", i_Top_level_json, false);
            }
            #region Body Section.
            if (i_Top_level.TOP_LEVEL_ID == null || i_Top_level.TOP_LEVEL_ID == 0)
            {
                throw new BLC_Exception("Missing primary key while calling Edit_Top_level");
            }
            if (oEditMode_Flag == Enum_Edit_Mode.Add)
            {
                i_Top_level.ENTRY_DATE = Tools.GetDateTimeString(DateTime.Now);
                i_Top_level.IS_DELETED = false;
            }
            else
            {
                _Top_level = Get_Top_level_By_TOP_LEVEL_ID(new Params_Get_Top_level_By_TOP_LEVEL_ID
                {
                    TOP_LEVEL_ID = i_Top_level.TOP_LEVEL_ID
                });
            }
            i_Top_level.OWNER_ID = this.oBLC_Initializer.Owner_ID;
            i_Top_level.ENTRY_USER_ID = this.oBLC_Initializer.User_ID;
            i_Top_level.LAST_UPDATE = Tools.GetDateTimeString(DateTime.Now);
            if (_Stop_Edit_Top_level_Execution)
            {
                _Stop_Edit_Top_level_Execution = false;
                return;
            }
            i_Top_level.TOP_LEVEL_ID = _AppContext.Edit_Top_level
            (
                i_Top_level.TOP_LEVEL_ID,
                i_Top_level.NAME,
                i_Top_level.LOCATION,
                i_Top_level.AREA,
                i_Top_level.IMAGE_URL,
                i_Top_level.LOGO_URL,
                i_Top_level.AREA_COLOR,
                i_Top_level.BORDER_COLOR,
                i_Top_level.STUDY_ZONE_NAME,
                i_Top_level.LOW_THRESHOLD,
                i_Top_level.HIGH_THRESHOLD,
                i_Top_level.ENTRY_USER_ID,
                i_Top_level.ENTRY_DATE,
                i_Top_level.LAST_UPDATE,
                i_Top_level.IS_DELETED,
                i_Top_level.OWNER_ID
            );
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Edit_Top_level", i_Top_level_json, false);
            }
        }
        #endregion
        ...
        #endregion
        #region Edit_Top_level_List
        public void Edit_Top_level_List(Params_Edit_Top_level_List i_Params_Edit_Top_level_List)
        {
            var i_Params_Edit_Top_level_List_json = JsonConvert.SerializeObject(i_Params_Edit_Top_level_List);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Edit_Top_level_List", i_Params_Edit_Top_level_List_json, false);
            }
            #region Body Section.
            if (i_Params_Edit_Top_level_List.List_To_Edit != null)
            {
                i_Params_Edit_Top_level_List.List_Failed_Edit = new List<Top_level>();
                if (i_Params_Edit_Top_level_List.List_To_Edit.Count() > 0)
                {
                    foreach (var oTop_level in i_Params_Edit_Top_level_List.List_To_Edit)
                    {
                        try
                        {
                            Edit_Top_level(oTop_level);
                        }
                        catch
                        {
                            i_Params_Edit_Top_level_List.List_Failed_Edit.Add(oTop_level);
                        }
                    }
                }
                i_Params_Edit_Top_level_List.List_To_Edit = i_Params_Edit_Top_level_List.List_To_Edit.Except(i_Params_Edit_Top_level_List.List_Failed_Edit).ToList();
            }
            if (i_Params_Edit_Top_level_List.List_To_Delete != null)
            {
                i_Params_Edit_Top_level_List.List_Failed_Delete = new List<long?>();
                if (i_Params_Edit_Top_level_List.List_To_Delete.Count() > 0)
                {
                    foreach (var Top_level_ID in i_Params_Edit_Top_level_List.List_To_Delete)
                    {
                        try
                        {
                            Delete_Top_level(new Params_Delete_Top_level()
                            {
                        ...
                        {
                            i_Params_Edit_Top_level_List.List_Failed_Delete.Add(Top_level_ID);
                        }
                    }
                }
                i_Params_Edit_Top_level_List.List_To_Delete = i_Params_Edit_Top_level_List.List_To_Delete.Except(i_Params_Edit_Top_level_List.List_Failed_Delete);
            }
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Edit_Top_level_List", i_Params_Edit_Top_level_List_json, false);
            }
        }
        #endregion
