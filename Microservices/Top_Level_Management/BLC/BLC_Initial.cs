...
namespace BLC
{
    ...
    public partial class BLC : IDisposable
    {
        ...
        {
            #region Body Section.
            OnPostEvent_Get_Top_level_By_TOP_LEVEL_ID_List += new PostEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID_List(BLC_OnPostEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID_List);
            #endregion
        }
        #endregion
        ...
        #region BLC_OnPostEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID_List
        public void BLC_OnPostEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID_List(List<Top_level> i_Result, Params_Get_Top_level_By_TOP_LEVEL_ID_List i_Params_Get_Top_level_By_TOP_LEVEL_ID_List)
        {
