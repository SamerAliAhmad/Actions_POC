...
namespace BLC
{
    public partial class BLC
    {
        ...
        #endregion
        #region Get_Top_level_By_TOP_LEVEL_ID_List Event
        public delegate void PreEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID_List(Params_Get_Top_level_By_TOP_LEVEL_ID_List i_Params_Get_Top_level_By_TOP_LEVEL_ID_List);
        public delegate void PostEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID_List(List<Top_level> i_Result, Params_Get_Top_level_By_TOP_LEVEL_ID_List i_Params_Get_Top_level_By_TOP_LEVEL_ID_List);
        public event PreEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID_List OnPreEvent_Get_Top_level_By_TOP_LEVEL_ID_List;
        public event PostEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID_List OnPostEvent_Get_Top_level_By_TOP_LEVEL_ID_List;
        #endregion
        ...
        #endregion
        #region Get_Top_level_By_TOP_LEVEL_ID Event
        public delegate void PreEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID(Params_Get_Top_level_By_TOP_LEVEL_ID i_Params_Get_Top_level_By_TOP_LEVEL_ID);
        public delegate void PostEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID(Top_level i_Result, Params_Get_Top_level_By_TOP_LEVEL_ID i_Params_Get_Top_level_By_TOP_LEVEL_ID);
        public event PreEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID OnPreEvent_Get_Top_level_By_TOP_LEVEL_ID;
        public event PostEvent_Handler_Get_Top_level_By_TOP_LEVEL_ID OnPostEvent_Get_Top_level_By_TOP_LEVEL_ID;
        #endregion
