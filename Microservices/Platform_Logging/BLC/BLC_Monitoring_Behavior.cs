...
namespace BLC
{
    public partial class BLC
    {
        ...
        public Stopwatch _Execution_Time_Create_Log { get; set; }
        public Stopwatch _Execution_Time_Delete_Log { get; set; }
        public Stopwatch _Execution_Time_Edit_Log_List { get; set; }
        public Stopwatch _Execution_Time_Get_Logs_By_Where { get; set; }
        public Stopwatch _Execution_Time_Generate_Logs_Excel { get; set; }
        public Stopwatch _Execution_Time_Get_Logs_With_Filters { get; set; }
        public Stopwatch _Execution_Time_Get_Logs_By_Where_Sorted_With_Pagination { get; set; }
        #endregion
