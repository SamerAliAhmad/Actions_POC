...
namespace BLC
{
    public static partial class Global
    {
        ...
        public static string Assets_Excel_Report_Path = ConfigurationManager.AppSettings["ASSETS_EXCEL_REPORT_PATH"];
    }
    ...
    #endregion
    #region Generate_Logs_Excel_Response
    public class Generate_Logs_Excel_Response
    {
