...
namespace BLC
{
    public partial class BLC
    {
        ...
        private Data_source _Data_source;
        private List<Data_source> _List_Data_source;
        ...
        private bool _Stop_Edit_Data_source_Execution;
        private bool _Stop_Delete_Data_source_Execution;
        ...
        public Data_source Get_Data_source_By_DATA_SOURCE_ID(Params_Get_Data_source_By_DATA_SOURCE_ID i_Params_Get_Data_source_By_DATA_SOURCE_ID)
        {
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Data_source_By_DATA_SOURCE_ID", i_Params_Get_Data_source_By_DATA_SOURCE_ID_json, false);
            }
            #region Body Section.
            DALC.Data_source oDBEntry = _AppContext.Get_Data_source_By_DATA_SOURCE_ID(i_Params_Get_Data_source_By_DATA_SOURCE_ID.DATA_SOURCE_ID);
            if (oDBEntry == null)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Data_source_By_DATA_SOURCE_ID", i_Params_Get_Data_source_By_DATA_SOURCE_ID_json, false);
            }
            return oData_source;
        }
        #endregion
        ...
        public List<Data_source> Get_Data_source_By_DATA_SOURCE_ID_List(Params_Get_Data_source_By_DATA_SOURCE_ID_List i_Params_Get_Data_source_By_DATA_SOURCE_ID_List)
        {
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Data_source_By_DATA_SOURCE_ID_List", i_Params_Get_Data_source_By_DATA_SOURCE_ID_List_json, false);
            }
            #region Body Section.
            List<DALC.Data_source> oList_DBEntry = _AppContext.Get_Data_source_By_DATA_SOURCE_ID_List(i_Params_Get_Data_source_By_DATA_SOURCE_ID_List.DATA_SOURCE_ID_LIST);
            if (oList_DBEntry != null)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Data_source_By_DATA_SOURCE_ID_List", i_Params_Get_Data_source_By_DATA_SOURCE_ID_List_json, false);
            }
        ...
        public List<Data_source> Get_Data_source_By_OWNER_ID(Params_Get_Data_source_By_OWNER_ID i_Params_Get_Data_source_By_OWNER_ID)
        {
            List<Data_source> oList_Data_source = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Data_source_By_OWNER_ID", i_Params_Get_Data_source_By_OWNER_ID_json, false);
            }
            #region Body Section.
            List<DALC.Data_source> oList_DBEntry = _AppContext.Get_Data_source_By_OWNER_ID(i_Params_Get_Data_source_By_OWNER_ID.OWNER_ID);
            if (oList_DBEntry != null)
            {
                oList_Data_source = new List<Data_source>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Data_source_By_OWNER_ID", i_Params_Get_Data_source_By_OWNER_ID_json, false);
            }
            return oList_Data_source;
        }
        #endregion
        #region Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID
        public List<Data_source> Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID(Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID i_Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID)
        {
            List<Data_source> oList_Data_source = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID", i_Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_json, false);
            }
            #region Body Section.
            List<DALC.Data_source> oList_DBEntry = _AppContext.Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID(i_Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID.DATA_SOURCE_AUTHENTICATION_ID);
            if (oList_DBEntry != null)
            {
                oList_Data_source = new List<Data_source>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID", i_Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_json, false);
            }
            return oList_Data_source;
        }
        #endregion
        #region Get_Data_source_By_OWNER_ID_IS_DELETED
        public List<Data_source> Get_Data_source_By_OWNER_ID_IS_DELETED(Params_Get_Data_source_By_OWNER_ID_IS_DELETED i_Params_Get_Data_source_By_OWNER_ID_IS_DELETED)
        {
            List<Data_source> oList_Data_source = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Data_source_By_OWNER_ID_IS_DELETED", i_Params_Get_Data_source_By_OWNER_ID_IS_DELETED_json, false);
            }
            #region Body Section.
            List<DALC.Data_source> oList_DBEntry = _AppContext.Get_Data_source_By_OWNER_ID_IS_DELETED(i_Params_Get_Data_source_By_OWNER_ID_IS_DELETED.OWNER_ID, i_Params_Get_Data_source_By_OWNER_ID_IS_DELETED.IS_DELETED);
            if (oList_DBEntry != null)
            {
                oList_Data_source = new List<Data_source>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Data_source_By_OWNER_ID_IS_DELETED", i_Params_Get_Data_source_By_OWNER_ID_IS_DELETED_json, false);
            }
            return oList_Data_source;
        }
        #endregion
        ...
        public List<Data_source> Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List(Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List i_Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List)
        {
            List<Data_source> oList_Data_source = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List", i_Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List_json, false);
            }
            #region Body Section.
            List<DALC.Data_source> oList_DBEntry = _AppContext.Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List(i_Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List.DATA_SOURCE_AUTHENTICATION_ID_LIST);
            if (oList_DBEntry != null)
            {
                oList_Data_source = new List<Data_source>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List", i_Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_List_json, false);
            }
            return oList_Data_source;
        }
        #endregion
        ...
        public List<Data_source> Get_Data_source_By_Where(Params_Get_Data_source_By_Where i_Params_Get_Data_source_By_Where)
        {
            long? tmp_TOTAL_COUNT = 0;
            List<Data_source> oList_Data_source = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Data_source_By_Where", i_Params_Get_Data_source_By_Where_json, false);
            }
            #region Body Section.
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Data_source_By_Where", i_Params_Get_Data_source_By_Where_json, false);
            }
            return oList_Data_source;
        }
        #endregion
        ...
        public List<Data_source> Get_Data_source_By_Where_In_List(Params_Get_Data_source_By_Where_In_List i_Params_Get_Data_source_By_Where_In_List)
        {
            long? tmp_TOTAL_COUNT = 0;
            List<Data_source> oList_Data_source = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Data_source_By_Where_In_List", i_Params_Get_Data_source_By_Where_In_List_json, false);
            }
            #region Body Section.
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Data_source_By_Where_In_List", i_Params_Get_Data_source_By_Where_In_List_json, false);
            }
            return oList_Data_source;
        }
        #endregion
        ...
        public void Delete_Data_source(Params_Delete_Data_source i_Params_Delete_Data_source)
        {
            var i_Params_Delete_Data_source_json = JsonConvert.SerializeObject(i_Params_Delete_Data_source);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Data_source", i_Params_Delete_Data_source_json, false);
            }
            #region Body Section.
            try
            {
                Params_Get_Data_source_By_DATA_SOURCE_ID oParams_Get_Data_source_By_DATA_SOURCE_ID = new Params_Get_Data_source_By_DATA_SOURCE_ID
                {
                    DATA_SOURCE_ID = i_Params_Delete_Data_source.DATA_SOURCE_ID
                };
                _Data_source = Get_Data_source_By_DATA_SOURCE_ID(oParams_Get_Data_source_By_DATA_SOURCE_ID);
                if (_Data_source != null)
                {
                    if (_Stop_Delete_Data_source_Execution)
                    {
                        _Stop_Delete_Data_source_Execution = false;
                        return;
                    }
                    _AppContext.Delete_Data_source(i_Params_Delete_Data_source.DATA_SOURCE_ID);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Data_source", i_Params_Delete_Data_source_json, false);
            }
        }
        #endregion
        ...
        public void Delete_Data_source_By_OWNER_ID(Params_Delete_Data_source_By_OWNER_ID i_Params_Delete_Data_source_By_OWNER_ID)
        {
            var i_Params_Delete_Data_source_By_OWNER_ID_json = JsonConvert.SerializeObject(i_Params_Delete_Data_source_By_OWNER_ID);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Data_source_By_OWNER_ID", i_Params_Delete_Data_source_By_OWNER_ID_json, false);
            }
            #region Body Section.
            try
            {
                ...
                {
                    OWNER_ID = i_Params_Delete_Data_source_By_OWNER_ID.OWNER_ID
                };
                _List_Data_source = Get_Data_source_By_OWNER_ID(oParams_Get_Data_source_By_OWNER_ID);
                if (_List_Data_source != null && _List_Data_source.Count > 0)
                {
                    if (_Stop_Delete_Data_source_Execution)
                    {
                        _Stop_Delete_Data_source_Execution = false;
                    ...
                    _AppContext.Delete_Data_source_By_OWNER_ID(i_Params_Delete_Data_source_By_OWNER_ID.OWNER_ID);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Data_source_By_OWNER_ID", i_Params_Delete_Data_source_By_OWNER_ID_json, false);
            }
        }
        #endregion
        #region Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID
        public void Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID(Params_Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID i_Params_Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID)
        {
            var i_Params_Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_json = JsonConvert.SerializeObject(i_Params_Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID", i_Params_Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_json, false);
            }
            #region Body Section.
            try
            {
                Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID oParams_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID = new Params_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID
                {
                    DATA_SOURCE_AUTHENTICATION_ID = i_Params_Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID.DATA_SOURCE_AUTHENTICATION_ID
                };
                _List_Data_source = Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID(oParams_Get_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID);
                if (_List_Data_source != null && _List_Data_source.Count > 0)
                {
                    if (_Stop_Delete_Data_source_Execution)
                    {
                    ...
                    _AppContext.Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID(i_Params_Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID.DATA_SOURCE_AUTHENTICATION_ID);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID", i_Params_Delete_Data_source_By_DATA_SOURCE_AUTHENTICATION_ID_json, false);
            }
        }
        #endregion
        #region Delete_Data_source_By_OWNER_ID_IS_DELETED
        public void Delete_Data_source_By_OWNER_ID_IS_DELETED(Params_Delete_Data_source_By_OWNER_ID_IS_DELETED i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED)
        {
            var i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED_json = JsonConvert.SerializeObject(i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Data_source_By_OWNER_ID_IS_DELETED", i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED_json, false);
            }
            #region Body Section.
            try
            {
                Params_Get_Data_source_By_OWNER_ID_IS_DELETED oParams_Get_Data_source_By_OWNER_ID_IS_DELETED = new Params_Get_Data_source_By_OWNER_ID_IS_DELETED
                {
                    OWNER_ID = i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED.OWNER_ID,
                    IS_DELETED = i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED.IS_DELETED
                };
                _List_Data_source = Get_Data_source_By_OWNER_ID_IS_DELETED(oParams_Get_Data_source_By_OWNER_ID_IS_DELETED);
                if (_List_Data_source != null && _List_Data_source.Count > 0)
                {
                    if (_Stop_Delete_Data_source_Execution)
                    {
                    ...
                    _AppContext.Delete_Data_source_By_OWNER_ID_IS_DELETED(i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED.OWNER_ID, i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED.IS_DELETED);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Data_source_By_OWNER_ID_IS_DELETED", i_Params_Delete_Data_source_By_OWNER_ID_IS_DELETED_json, false);
            }
        }
        #endregion
        ...
        public void Edit_Data_source(Data_source i_Data_source)
        {
            var i_Data_source_json = JsonConvert.SerializeObject(i_Data_source);

            Enum_Edit_Mode oEditMode_Flag = Enum_Edit_Mode.Update;
            if (i_Data_source.DATA_SOURCE_ID == -1)
            {
                oEditMode_Flag = Enum_Edit_Mode.Add;
            }
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Edit_Data_source", i_Data_source_json, false);
            }
            #region Body Section.
            if (i_Data_source.DATA_SOURCE_ID == null || i_Data_source.DATA_SOURCE_ID == 0)
            {
                throw new BLC_Exception("Missing primary key while calling Edit_Data_source");
            }
            if (oEditMode_Flag == Enum_Edit_Mode.Add)
            {
                i_Data_source.ENTRY_DATE = Tools.GetDateTimeString(DateTime.Now);
                i_Data_source.IS_DELETED = false;
            }
            else
            {
                _Data_source = Get_Data_source_By_DATA_SOURCE_ID(new Params_Get_Data_source_By_DATA_SOURCE_ID
                {
                    DATA_SOURCE_ID = i_Data_source.DATA_SOURCE_ID
                });
            }
            i_Data_source.OWNER_ID = this.oBLC_Initializer.Owner_ID;
            i_Data_source.ENTRY_USER_ID = this.oBLC_Initializer.User_ID;
            i_Data_source.LAST_UPDATE = Tools.GetDateTimeString(DateTime.Now);
            if (_Stop_Edit_Data_source_Execution)
            {
                _Stop_Edit_Data_source_Execution = false;
                return;
            }
            i_Data_source.DATA_SOURCE_ID = _AppContext.Edit_Data_source
            (
                i_Data_source.DATA_SOURCE_ID,
                i_Data_source.NAME,
                i_Data_source.API_URL,
                i_Data_source.MIN_DWELL_TIME_IN_MINUTES,
                i_Data_source.MAX_DWELL_TIME_IN_MINUTES,
                i_Data_source.DATA_SOURCE_AUTHENTICATION_ID,
                i_Data_source.ENTRY_USER_ID,
                i_Data_source.ENTRY_DATE,
                i_Data_source.LAST_UPDATE,
                i_Data_source.IS_DELETED,
                i_Data_source.OWNER_ID
            );
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Edit_Data_source", i_Data_source_json, false);
            }
        }
        #endregion
        ...
        #endregion
        #region Edit_Data_source_List
        public void Edit_Data_source_List(Params_Edit_Data_source_List i_Params_Edit_Data_source_List)
        {
            var i_Params_Edit_Data_source_List_json = JsonConvert.SerializeObject(i_Params_Edit_Data_source_List);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Edit_Data_source_List", i_Params_Edit_Data_source_List_json, false);
            }
            #region Body Section.
            if (i_Params_Edit_Data_source_List.List_To_Edit != null)
            {
                i_Params_Edit_Data_source_List.List_Failed_Edit = new List<Data_source>();
                if (i_Params_Edit_Data_source_List.List_To_Edit.Count() > 0)
                {
                    foreach (var oData_source in i_Params_Edit_Data_source_List.List_To_Edit)
                    {
                        try
                        {
                            Edit_Data_source(oData_source);
                        }
                        catch
                        {
                            i_Params_Edit_Data_source_List.List_Failed_Edit.Add(oData_source);
                        }
                    }
                }
                i_Params_Edit_Data_source_List.List_To_Edit = i_Params_Edit_Data_source_List.List_To_Edit.Except(i_Params_Edit_Data_source_List.List_Failed_Edit).ToList();
            }
            if (i_Params_Edit_Data_source_List.List_To_Delete != null)
            {
                i_Params_Edit_Data_source_List.List_Failed_Delete = new List<int?>();
                if (i_Params_Edit_Data_source_List.List_To_Delete.Count() > 0)
                {
                    foreach (var Data_source_ID in i_Params_Edit_Data_source_List.List_To_Delete)
                    {
                        try
                        {
                            Delete_Data_source(new Params_Delete_Data_source()
                            {
                        ...
                        {
                            i_Params_Edit_Data_source_List.List_Failed_Delete.Add(Data_source_ID);
                        }
                    }
                }
                i_Params_Edit_Data_source_List.List_To_Delete = i_Params_Edit_Data_source_List.List_To_Delete.Except(i_Params_Edit_Data_source_List.List_Failed_Delete);
            }
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Edit_Data_source_List", i_Params_Edit_Data_source_List_json, false);
            }
        }
        #endregion
