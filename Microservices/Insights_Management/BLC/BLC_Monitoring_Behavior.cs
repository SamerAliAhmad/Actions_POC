...
namespace BLC
{
    public partial class BLC
    {
        ...
        public Stopwatch _Execution_Time_Get_Correlation_method_By_CORRELATION_METHOD_ID { get; set; }
        public Stopwatch _Execution_Time_Get_Correlation_method_By_CORRELATION_METHOD_ID_List { get; set; }
        public Stopwatch _Execution_Time_Get_Correlation_method_By_OWNER_ID { get; set; }
        public Stopwatch _Execution_Time_Get_Correlation_method_By_OWNER_ID_IS_DELETED { get; set; }
        public Stopwatch _Execution_Time_Get_Correlation_method_By_Where { get; set; }
        public Stopwatch _Execution_Time_Delete_Correlation_method { get; set; }
        public Stopwatch _Execution_Time_Delete_Correlation_method_By_OWNER_ID { get; set; }
        public Stopwatch _Execution_Time_Delete_Correlation_method_By_OWNER_ID_IS_DELETED { get; set; }
        public Stopwatch _Execution_Time_Edit_Correlation_method { get; set; }
        public Stopwatch _Execution_Time_Edit_Correlation_method_List { get; set; }
        public Stopwatch _Execution_Time_Get_Comparison_Data { get; set; }
        public Stopwatch _Execution_Time_Get_Single_kpi_comparison { get; set; }
        public Stopwatch _Execution_Time_Get_Multi_kpi_comparison { get; set; }
        public Stopwatch _Execution_Time_Get_Correlation { get; set; }
        #endregion
