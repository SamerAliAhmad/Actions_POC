...
namespace BLC
{
    public partial class BLC
    {
        ...
        #region Get_Correlation_method_By_OWNER_ID Event
        public delegate void PreEvent_Handler_Get_Correlation_method_By_OWNER_ID(Params_Get_Correlation_method_By_OWNER_ID i_Params_Get_Correlation_method_By_OWNER_ID);
        public delegate void PostEvent_Handler_Get_Correlation_method_By_OWNER_ID(List<Correlation_method> i_Result, Params_Get_Correlation_method_By_OWNER_ID i_Params_Get_Correlation_method_By_OWNER_ID);
        public event PreEvent_Handler_Get_Correlation_method_By_OWNER_ID OnPreEvent_Get_Correlation_method_By_OWNER_ID;
        public event PostEvent_Handler_Get_Correlation_method_By_OWNER_ID OnPostEvent_Get_Correlation_method_By_OWNER_ID;
        #endregion
        #endregion
    }
}