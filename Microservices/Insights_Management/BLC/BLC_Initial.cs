...
namespace BLC
{
    ...
    public partial class BLC : IDisposable
    {
        ...
        {
            #region Body Section.
            OnPostEvent_Get_Correlation_method_By_OWNER_ID += new PostEvent_Handler_Get_Correlation_method_By_OWNER_ID(BLC_OnPostEvent_Get_Correlation_method_By_OWNER_ID);
            #endregion
        }
        #endregion
        ...
        public void BLC_OnPostEvent_Get_Correlation_method_By_OWNER_ID(List<Correlation_method> i_Result, Params_Get_Correlation_method_By_OWNER_ID i_Params_Get_Correlation_method_By_OWNER_ID)
        {
            if (i_Result != null && i_Result.Count > 0)
            {
                i_Result = i_Result.Select(oCorrelation_method =>
                {
                    if (!oCorrelation_method.EQUATION_URL.StartsWith(Global.Assets_Endpoint))
                    {
                        oCorrelation_method.EQUATION_URL = $"{Global.Assets_Endpoint}/{oCorrelation_method.EQUATION_URL}";
                    }
