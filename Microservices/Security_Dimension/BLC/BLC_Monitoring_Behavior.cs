...
namespace BLC
{
    public partial class BLC
    {
        ...
        public Stopwatch _Execution_Time_Delete_Incident { get; set; }
        public Stopwatch _Execution_Time_Edit_Incident_List { get; set; }
        public Stopwatch _Execution_Time_Get_Incidents_By_Where { get; set; }
        public Stopwatch _Execution_Time_Get_Incidents_By_Where_Count { get; set; }
        public Stopwatch _Execution_Time_Get_Incidents_By_Where_Sorted_With_Pagination { get; set; }
        #endregion
