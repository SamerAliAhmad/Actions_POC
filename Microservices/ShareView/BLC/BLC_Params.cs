...
namespace BLC
{
    ...
    #endregion
    #region Params_Get_Share_file_By_SHARE_FILE_ID
    ...
    #endregion
    #region Params_Get_Share_file_By_SHARE_FILE_ID_List
    public partial class Params_Get_Share_file_By_SHARE_FILE_ID_List
    {
        #region Properties
        public IEnumerable<int?> SHARE_FILE_ID_LIST { get; set; }
        #endregion
    }
    #endregion
    ...
    #endregion
    #region Params_Get_Share_file_By_OWNER_ID
    public partial class Params_Get_Share_file_By_OWNER_ID
    {
        #region Properties
        public int? OWNER_ID { get; set; }
        #endregion
    ...
    #endregion
    #region Params_Get_Share_file_By_USER_ID
    ...
    #endregion
    #region Params_Get_Share_file_By_OWNER_ID_IS_DELETED
    public partial class Params_Get_Share_file_By_OWNER_ID_IS_DELETED
    {
        #region Properties
        public int? OWNER_ID { get; set; }
        public bool IS_DELETED { get; set; }
    ...
    #endregion
    #region Params_Get_Share_file_By_USER_ID_List
    public partial class Params_Get_Share_file_By_USER_ID_List
    {
        #region Properties
    ...
    #endregion
    #region Params_Get_Share_file_By_Where
    public partial class Params_Get_Share_file_By_Where
    {
        #region Properties
        public int? OWNER_ID { get; set; }
    ...
    #endregion
    #region Params_Get_Share_file_By_Where_In_List
    public partial class Params_Get_Share_file_By_Where_In_List
    {
        #region Properties
        public int? OWNER_ID { get; set; }
        public string FILE_NAME { get; set; }
    ...
    #endregion
    #region Params_Delete_Share_file
    ...
    #endregion
    #region Params_Delete_Share_file_By_OWNER_ID
    public partial class Params_Delete_Share_file_By_OWNER_ID
    {
        #region Properties
        public int? OWNER_ID { get; set; }
        #endregion
    ...
    #endregion
    #region Params_Delete_Share_file_By_USER_ID
    public partial class Params_Delete_Share_file_By_USER_ID
    {
        #region Properties
        public long? USER_ID { get; set; }
        #endregion
    ...
    #endregion
    #region Params_Delete_Share_file_By_OWNER_ID_IS_DELETED
    public partial class Params_Delete_Share_file_By_OWNER_ID_IS_DELETED
    {
        #region Properties
        public int? OWNER_ID { get; set; }
        public bool IS_DELETED { get; set; }
    ...
    #endregion
    #region Params_Edit_Share_file_List
    public partial class Params_Edit_Share_file_List
    {
        #region Properties
        public List<Share_file> List_To_Edit { get; set; }
        public List<Share_file> List_Failed_Edit { get; set; }
        public IEnumerable<int?> List_To_Delete { get; set; }
        public List<int?> List_Failed_Delete { get; set; }
        #endregion
    }
