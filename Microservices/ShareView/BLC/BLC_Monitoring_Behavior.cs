...
namespace BLC
{
    public partial class BLC
    {
        ...
        public Stopwatch _Execution_Time_Get_Share_file_By_SHARE_FILE_ID { get; set; }
        public Stopwatch _Execution_Time_Get_Setup_By_SETUP_ID_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_SHARE_FILE_ID_Adv { get; set; }
        ...
        public Stopwatch _Execution_Time_Get_Share_file_By_SHARE_FILE_ID_List { get; set; }
        public Stopwatch _Execution_Time_Get_Setup_By_SETUP_ID_List_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_SHARE_FILE_ID_List_Adv { get; set; }
        ...
        public Stopwatch _Execution_Time_Get_Share_file_By_OWNER_ID { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_USER_ID { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_OWNER_ID_IS_DELETED { get; set; }
        ...
        public Stopwatch _Execution_Time_Get_Share_file_By_OWNER_ID_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_USER_ID_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_OWNER_ID_IS_DELETED_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Setup_By_SETUP_CATEGORY_ID_List { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_USER_ID_List { get; set; }
        public Stopwatch _Execution_Time_Get_Setup_By_SETUP_CATEGORY_ID_List_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_USER_ID_List_Adv { get; set; }
        ...
        public Stopwatch _Execution_Time_Get_Share_file_By_Where { get; set; }
        public Stopwatch _Execution_Time_Get_Setup_By_Where_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_Where_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Setup_By_Where_In_List { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_Where_In_List { get; set; }
        public Stopwatch _Execution_Time_Get_Setup_By_Where_In_List_Adv { get; set; }
        public Stopwatch _Execution_Time_Get_Share_file_By_Where_In_List_Adv { get; set; }
        public Stopwatch _Execution_Time_Delete_Setup_category { get; set; }
        public Stopwatch _Execution_Time_Delete_Setup { get; set; }
        public Stopwatch _Execution_Time_Delete_Share_file { get; set; }
        ...
        public Stopwatch _Execution_Time_Delete_Share_file_By_OWNER_ID { get; set; }
        public Stopwatch _Execution_Time_Delete_Share_file_By_USER_ID { get; set; }
        public Stopwatch _Execution_Time_Delete_Share_file_By_OWNER_ID_IS_DELETED { get; set; }
        public Stopwatch _Execution_Time_Edit_Setup_category { get; set; }
        public Stopwatch _Execution_Time_Edit_Setup { get; set; }
        public Stopwatch _Execution_Time_Edit_Share_file { get; set; }
        ...
        public Stopwatch _Execution_Time_Edit_Share_file_List { get; set; }
        public Stopwatch _Execution_Time_isDark { get; set; }
        public Stopwatch _Execution_Time_Get_File_Full_Path { get; set; }
        public Stopwatch _Execution_Time_Upload_Share_File { get; set; }
        public Stopwatch _Execution_Time_Send_Share_Link_By_Email { get; set; }
        public Stopwatch _Execution_Time_Delete_Entity_share_data { get; set; }
        public Stopwatch _Execution_Time_Edit_Entity_share_data { get; set; }
        public Stopwatch _Execution_Time_Get_Entity_share_data_By_UNIQUE_STRING { get; set; }
        public Stopwatch _Execution_Time_Get_Entity_share_view_data { get; set; }
        #endregion
