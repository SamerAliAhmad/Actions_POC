...
namespace BLC
{
    public partial class BLC
    {
        ...
        private Share_file _Share_file;
        private List<Share_file> _List_Share_file;
        #endregion
        ...
        private bool _Stop_Edit_Share_file_Execution;
        private bool _Stop_Delete_Share_file_Execution;
        #endregion
        #endregion
        ...
        public Share_file Get_Share_file_By_SHARE_FILE_ID(Params_Get_Share_file_By_SHARE_FILE_ID i_Params_Get_Share_file_By_SHARE_FILE_ID)
        {
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Share_file_By_SHARE_FILE_ID", i_Params_Get_Share_file_By_SHARE_FILE_ID_json, false);
            }
            #region Body Section.
            DALC.Share_file oDBEntry = _AppContext.Get_Share_file_By_SHARE_FILE_ID(i_Params_Get_Share_file_By_SHARE_FILE_ID.SHARE_FILE_ID);
            if (oDBEntry == null)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Share_file_By_SHARE_FILE_ID", i_Params_Get_Share_file_By_SHARE_FILE_ID_json, false);
            }
            return oShare_file;
        }
        #endregion
        ...
        public List<Share_file> Get_Share_file_By_SHARE_FILE_ID_List(Params_Get_Share_file_By_SHARE_FILE_ID_List i_Params_Get_Share_file_By_SHARE_FILE_ID_List)
        {
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Share_file_By_SHARE_FILE_ID_List", i_Params_Get_Share_file_By_SHARE_FILE_ID_List_json, false);
            }
            #region Body Section.
            List<DALC.Share_file> oList_DBEntry = _AppContext.Get_Share_file_By_SHARE_FILE_ID_List(i_Params_Get_Share_file_By_SHARE_FILE_ID_List.SHARE_FILE_ID_LIST);
            if (oList_DBEntry != null)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Share_file_By_SHARE_FILE_ID_List", i_Params_Get_Share_file_By_SHARE_FILE_ID_List_json, false);
            }
        ...
        public List<Share_file> Get_Share_file_By_OWNER_ID(Params_Get_Share_file_By_OWNER_ID i_Params_Get_Share_file_By_OWNER_ID)
        {
            List<Share_file> oList_Share_file = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Share_file_By_OWNER_ID", i_Params_Get_Share_file_By_OWNER_ID_json, false);
            }
            #region Body Section.
            List<DALC.Share_file> oList_DBEntry = _AppContext.Get_Share_file_By_OWNER_ID(i_Params_Get_Share_file_By_OWNER_ID.OWNER_ID);
            if (oList_DBEntry != null)
            {
                oList_Share_file = new List<Share_file>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Share_file_By_OWNER_ID", i_Params_Get_Share_file_By_OWNER_ID_json, false);
            }
            return oList_Share_file;
        }
        #endregion
        #region Get_Share_file_By_USER_ID
        public List<Share_file> Get_Share_file_By_USER_ID(Params_Get_Share_file_By_USER_ID i_Params_Get_Share_file_By_USER_ID)
        {
            List<Share_file> oList_Share_file = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Share_file_By_USER_ID", i_Params_Get_Share_file_By_USER_ID_json, false);
            }
            #region Body Section.
            List<DALC.Share_file> oList_DBEntry = _AppContext.Get_Share_file_By_USER_ID(i_Params_Get_Share_file_By_USER_ID.USER_ID);
            if (oList_DBEntry != null)
            {
                oList_Share_file = new List<Share_file>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Share_file_By_USER_ID", i_Params_Get_Share_file_By_USER_ID_json, false);
            }
            return oList_Share_file;
        }
        #endregion
        #region Get_Share_file_By_OWNER_ID_IS_DELETED
        public List<Share_file> Get_Share_file_By_OWNER_ID_IS_DELETED(Params_Get_Share_file_By_OWNER_ID_IS_DELETED i_Params_Get_Share_file_By_OWNER_ID_IS_DELETED)
        {
            List<Share_file> oList_Share_file = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Share_file_By_OWNER_ID_IS_DELETED", i_Params_Get_Share_file_By_OWNER_ID_IS_DELETED_json, false);
            }
            #region Body Section.
            List<DALC.Share_file> oList_DBEntry = _AppContext.Get_Share_file_By_OWNER_ID_IS_DELETED(i_Params_Get_Share_file_By_OWNER_ID_IS_DELETED.OWNER_ID, i_Params_Get_Share_file_By_OWNER_ID_IS_DELETED.IS_DELETED);
            if (oList_DBEntry != null)
            {
                oList_Share_file = new List<Share_file>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Share_file_By_OWNER_ID_IS_DELETED", i_Params_Get_Share_file_By_OWNER_ID_IS_DELETED_json, false);
            }
            return oList_Share_file;
        }
        #endregion
        ...
        public List<Share_file> Get_Share_file_By_USER_ID_List(Params_Get_Share_file_By_USER_ID_List i_Params_Get_Share_file_By_USER_ID_List)
        {
            List<Share_file> oList_Share_file = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Share_file_By_USER_ID_List", i_Params_Get_Share_file_By_USER_ID_List_json, false);
            }
            #region Body Section.
            List<DALC.Share_file> oList_DBEntry = _AppContext.Get_Share_file_By_USER_ID_List(i_Params_Get_Share_file_By_USER_ID_List.USER_ID_LIST);
            if (oList_DBEntry != null)
            {
                oList_Share_file = new List<Share_file>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Share_file_By_USER_ID_List", i_Params_Get_Share_file_By_USER_ID_List_json, false);
            }
            return oList_Share_file;
        }
        #endregion
        ...
        public List<Share_file> Get_Share_file_By_Where(Params_Get_Share_file_By_Where i_Params_Get_Share_file_By_Where)
        {
            long? tmp_TOTAL_COUNT = 0;
            List<Share_file> oList_Share_file = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Share_file_By_Where", i_Params_Get_Share_file_By_Where_json, false);
            }
            #region Body Section.
            ...
            List<DALC.Share_file> oList_DBEntry = _AppContext.Get_Share_file_By_Where(i_Params_Get_Share_file_By_Where.FILE_NAME, i_Params_Get_Share_file_By_Where.FILE_EXTENSION, i_Params_Get_Share_file_By_Where.OWNER_ID, i_Params_Get_Share_file_By_Where.OFFSET, i_Params_Get_Share_file_By_Where.FETCH_NEXT, ref tmp_TOTAL_COUNT);
            if (oList_DBEntry != null)
            {
                oList_Share_file = new List<Share_file>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Share_file_By_Where", i_Params_Get_Share_file_By_Where_json, false);
            }
            return oList_Share_file;
        }
        #endregion
        ...
        public List<Share_file> Get_Share_file_By_Where_In_List(Params_Get_Share_file_By_Where_In_List i_Params_Get_Share_file_By_Where_In_List)
        {
            long? tmp_TOTAL_COUNT = 0;
            List<Share_file> oList_Share_file = null;
            ...
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Get_Share_file_By_Where_In_List", i_Params_Get_Share_file_By_Where_In_List_json, false);
            }
            #region Body Section.
            ...
            List<DALC.Share_file> oList_DBEntry = _AppContext.Get_Share_file_By_Where_In_List(i_Params_Get_Share_file_By_Where_In_List.FILE_NAME, i_Params_Get_Share_file_By_Where_In_List.FILE_EXTENSION, i_Params_Get_Share_file_By_Where_In_List.USER_ID_LIST, i_Params_Get_Share_file_By_Where_In_List.OWNER_ID, i_Params_Get_Share_file_By_Where_In_List.OFFSET, i_Params_Get_Share_file_By_Where_In_List.FETCH_NEXT, ref tmp_TOTAL_COUNT);
            if (oList_DBEntry != null)
            {
                oList_Share_file = new List<Share_file>();
                if (oList_DBEntry.Count > 0)
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Get_Share_file_By_Where_In_List", i_Params_Get_Share_file_By_Where_In_List_json, false);
            }
            return oList_Share_file;
        }
        #endregion
        ...
        public void Delete_Share_file(Params_Delete_Share_file i_Params_Delete_Share_file)
        {
            var i_Params_Delete_Share_file_json = JsonConvert.SerializeObject(i_Params_Delete_Share_file);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Share_file", i_Params_Delete_Share_file_json, false);
            }
            #region Body Section.
            try
            {
                ...
                {
                    SHARE_FILE_ID = i_Params_Delete_Share_file.SHARE_FILE_ID
                };
                _Share_file = Get_Share_file_By_SHARE_FILE_ID(oParams_Get_Share_file_By_SHARE_FILE_ID);
                if (_Share_file != null)
                {
                    if (_Stop_Delete_Share_file_Execution)
                    {
                        _Stop_Delete_Share_file_Execution = false;
                        return;
                    }
                    _AppContext.Delete_Share_file(i_Params_Delete_Share_file.SHARE_FILE_ID);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Share_file", i_Params_Delete_Share_file_json, false);
            }
        }
        #endregion
        ...
        public void Delete_Share_file_By_OWNER_ID(Params_Delete_Share_file_By_OWNER_ID i_Params_Delete_Share_file_By_OWNER_ID)
        {
            var i_Params_Delete_Share_file_By_OWNER_ID_json = JsonConvert.SerializeObject(i_Params_Delete_Share_file_By_OWNER_ID);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Share_file_By_OWNER_ID", i_Params_Delete_Share_file_By_OWNER_ID_json, false);
            }
            #region Body Section.
            try
            {
                Params_Get_Share_file_By_OWNER_ID oParams_Get_Share_file_By_OWNER_ID = new Params_Get_Share_file_By_OWNER_ID
                {
                    OWNER_ID = i_Params_Delete_Share_file_By_OWNER_ID.OWNER_ID
                };
                _List_Share_file = Get_Share_file_By_OWNER_ID(oParams_Get_Share_file_By_OWNER_ID);
                if (_List_Share_file != null && _List_Share_file.Count > 0)
                {
                    if (_Stop_Delete_Share_file_Execution)
                    {
                        _Stop_Delete_Share_file_Execution = false;
                    ...
                    _AppContext.Delete_Share_file_By_OWNER_ID(i_Params_Delete_Share_file_By_OWNER_ID.OWNER_ID);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Share_file_By_OWNER_ID", i_Params_Delete_Share_file_By_OWNER_ID_json, false);
            }
        }
        #endregion
        #region Delete_Share_file_By_USER_ID
        public void Delete_Share_file_By_USER_ID(Params_Delete_Share_file_By_USER_ID i_Params_Delete_Share_file_By_USER_ID)
        {
            var i_Params_Delete_Share_file_By_USER_ID_json = JsonConvert.SerializeObject(i_Params_Delete_Share_file_By_USER_ID);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Share_file_By_USER_ID", i_Params_Delete_Share_file_By_USER_ID_json, false);
            }
            #region Body Section.
            try
            {
                ...
                {
                    USER_ID = i_Params_Delete_Share_file_By_USER_ID.USER_ID
                };
                _List_Share_file = Get_Share_file_By_USER_ID(oParams_Get_Share_file_By_USER_ID);
                if (_List_Share_file != null && _List_Share_file.Count > 0)
                {
                    if (_Stop_Delete_Share_file_Execution)
                    {
                    ...
                    _AppContext.Delete_Share_file_By_USER_ID(i_Params_Delete_Share_file_By_USER_ID.USER_ID);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Share_file_By_USER_ID", i_Params_Delete_Share_file_By_USER_ID_json, false);
            }
        }
        #endregion
        #region Delete_Share_file_By_OWNER_ID_IS_DELETED
        public void Delete_Share_file_By_OWNER_ID_IS_DELETED(Params_Delete_Share_file_By_OWNER_ID_IS_DELETED i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED)
        {
            var i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED_json = JsonConvert.SerializeObject(i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Delete_Share_file_By_OWNER_ID_IS_DELETED", i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED_json, false);
            }
            #region Body Section.
            try
            {
                Params_Get_Share_file_By_OWNER_ID_IS_DELETED oParams_Get_Share_file_By_OWNER_ID_IS_DELETED = new Params_Get_Share_file_By_OWNER_ID_IS_DELETED
                {
                    OWNER_ID = i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED.OWNER_ID,
                    IS_DELETED = i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED.IS_DELETED
                };
                _List_Share_file = Get_Share_file_By_OWNER_ID_IS_DELETED(oParams_Get_Share_file_By_OWNER_ID_IS_DELETED);
                if (_List_Share_file != null && _List_Share_file.Count > 0)
                {
                    if (_Stop_Delete_Share_file_Execution)
                    {
                    ...
                    _AppContext.Delete_Share_file_By_OWNER_ID_IS_DELETED(i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED.OWNER_ID, i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED.IS_DELETED);
                }
            }
            catch (BLC_Exception BLCex)
            {
            ...
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Delete_Share_file_By_OWNER_ID_IS_DELETED", i_Params_Delete_Share_file_By_OWNER_ID_IS_DELETED_json, false);
            }
        }
        #endregion
        ...
        public void Edit_Share_file(Share_file i_Share_file)
        {
            var i_Share_file_json = JsonConvert.SerializeObject(i_Share_file);

            Enum_Edit_Mode oEditMode_Flag = Enum_Edit_Mode.Update;
            if (i_Share_file.SHARE_FILE_ID == -1)
            {
                oEditMode_Flag = Enum_Edit_Mode.Add;
            }
            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Edit_Share_file", i_Share_file_json, false);
            }
            #region Body Section.
            if (i_Share_file.SHARE_FILE_ID == null || i_Share_file.SHARE_FILE_ID == 0)
            {
                throw new BLC_Exception("Missing primary key while calling Edit_Share_file");
            }
            if (oEditMode_Flag == Enum_Edit_Mode.Add)
            {
                i_Share_file.ENTRY_DATE = Tools.GetDateTimeString(DateTime.Now);
                i_Share_file.IS_DELETED = false;
            }
            else
            {
                _Share_file = Get_Share_file_By_SHARE_FILE_ID(new Params_Get_Share_file_By_SHARE_FILE_ID
                {
                    SHARE_FILE_ID = i_Share_file.SHARE_FILE_ID
                });
            }
            i_Share_file.OWNER_ID = this.oBLC_Initializer.Owner_ID;
            i_Share_file.ENTRY_USER_ID = this.oBLC_Initializer.User_ID;
            i_Share_file.LAST_UPDATE = Tools.GetDateTimeString(DateTime.Now);
            if (_Stop_Edit_Share_file_Execution)
            {
                _Stop_Edit_Share_file_Execution = false;
                return;
            }
            i_Share_file.SHARE_FILE_ID = _AppContext.Edit_Share_file
            (
                i_Share_file.SHARE_FILE_ID,
                i_Share_file.USER_ID,
                i_Share_file.FILE_NAME,
                i_Share_file.FILE_EXTENSION,
                i_Share_file.ENTRY_USER_ID,
                i_Share_file.ENTRY_DATE,
                i_Share_file.LAST_UPDATE,
                i_Share_file.IS_DELETED,
                i_Share_file.OWNER_ID
            );
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Edit_Share_file", i_Share_file_json, false);
            }
        }
        #endregion
        ...
        #endregion
        #region Edit_Share_file_List
        public void Edit_Share_file_List(Params_Edit_Share_file_List i_Params_Edit_Share_file_List)
        {
            var i_Params_Edit_Share_file_List_json = JsonConvert.SerializeObject(i_Params_Edit_Share_file_List);

            if (OnPreEvent_General != null)
            {
                OnPreEvent_General("Edit_Share_file_List", i_Params_Edit_Share_file_List_json, false);
            }
            #region Body Section.
            if (i_Params_Edit_Share_file_List.List_To_Edit != null)
            {
                i_Params_Edit_Share_file_List.List_Failed_Edit = new List<Share_file>();
                if (i_Params_Edit_Share_file_List.List_To_Edit.Count() > 0)
                {
                    foreach (var oShare_file in i_Params_Edit_Share_file_List.List_To_Edit)
                    {
                        try
                        {
                        ...
                        {
                            i_Params_Edit_Share_file_List.List_Failed_Edit.Add(oShare_file);
                        }
                    }
                }
                i_Params_Edit_Share_file_List.List_To_Edit = i_Params_Edit_Share_file_List.List_To_Edit.Except(i_Params_Edit_Share_file_List.List_Failed_Edit).ToList();
            }
            if (i_Params_Edit_Share_file_List.List_To_Delete != null)
            {
                i_Params_Edit_Share_file_List.List_Failed_Delete = new List<int?>();
                if (i_Params_Edit_Share_file_List.List_To_Delete.Count() > 0)
                {
                    foreach (var Share_file_ID in i_Params_Edit_Share_file_List.List_To_Delete)
                    {
                        try
                        {
                            Delete_Share_file(new Params_Delete_Share_file()
                            {
                        ...
                        {
                            i_Params_Edit_Share_file_List.List_Failed_Delete.Add(Share_file_ID);
                        }
                    }
                }
                i_Params_Edit_Share_file_List.List_To_Delete = i_Params_Edit_Share_file_List.List_To_Delete.Except(i_Params_Edit_Share_file_List.List_Failed_Delete);
            }
            #endregion
            if (OnPostEvent_General != null)
            {
                OnPostEvent_General("Edit_Share_file_List", i_Params_Edit_Share_file_List_json, false);
            }
        }
        #endregion
    }
