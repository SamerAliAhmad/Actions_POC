...
namespace DALC
{
    public partial interface IDALC
    {
        ...
        Share_file Get_Share_file_By_SHARE_FILE_ID(int? SHARE_FILE_ID);
        #endregion
        ...
        List<Share_file> Get_Share_file_By_SHARE_FILE_ID_List(IEnumerable<int?> SHARE_FILE_ID_LIST);
        #endregion
        ...
        List<Share_file> Get_Share_file_By_OWNER_ID(int? OWNER_ID);
        #endregion
        #region Get_Share_file_By_USER_ID
        List<Share_file> Get_Share_file_By_USER_ID(long? USER_ID);
        #endregion
        #region Get_Share_file_By_OWNER_ID_IS_DELETED
        List<Share_file> Get_Share_file_By_OWNER_ID_IS_DELETED(int? OWNER_ID, bool IS_DELETED);
        #endregion
        ...
        List<Share_file> Get_Share_file_By_USER_ID_List(IEnumerable<long?> USER_ID_LIST);
        #endregion
        ...
        List<Share_file> Get_Share_file_By_Where(string FILE_NAME, string FILE_EXTENSION, int? OWNER_ID, long? OFFSET, long? FETCH_NEXT, ref long? TOTAL_COUNT);
        #endregion
        ...
        List<Share_file> Get_Share_file_By_Where_In_List(string FILE_NAME, string FILE_EXTENSION, IEnumerable<long?> USER_ID_LIST, int? OWNER_ID, long? OFFSET, long? FETCH_NEXT, ref long? TOTAL_COUNT);
        #endregion
        ...
        void Delete_Share_file(int? SHARE_FILE_ID);
        #endregion
        ...
        void Delete_Share_file_By_OWNER_ID(int? OWNER_ID);
        #endregion
        #region Delete_Share_file_By_USER_ID
        void Delete_Share_file_By_USER_ID(long? USER_ID);
        #endregion
        #region Delete_Share_file_By_OWNER_ID_IS_DELETED
        void Delete_Share_file_By_OWNER_ID_IS_DELETED(int? OWNER_ID, bool IS_DELETED);
        #endregion
        ...
        int? Edit_Share_file(int? SHARE_FILE_ID, long? USER_ID, string FILE_NAME, string FILE_EXTENSION, long? ENTRY_USER_ID, string ENTRY_DATE, string LAST_UPDATE, bool IS_DELETED, int? OWNER_ID);
        #endregion
    }
}
