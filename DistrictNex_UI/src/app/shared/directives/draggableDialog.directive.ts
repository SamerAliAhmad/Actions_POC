...
@Directive({
    selector: '[SmartrDraggableDialog]',
})
export class SmartrDraggableDialogDirective implements OnInit, OnDestroy {
    ...
    public ngOnInit(): void {
        ...
        this._handle =
            this._elementRef.nativeElement.parentElement.parentElement.parentElement;
        this._target =
            this._elementRef.nativeElement.parentElement.parentElement.parentElement;
        this._container =
        ...
        this._container.style.minWidth = this.minWidth;
        this._container.style.minHeight = this.minHeight;
        this._container.style.maxHeight = this.maxHeight;
        this._container.style.maxWidth = this.maxWidth;
        this._setupEvents();
    }
