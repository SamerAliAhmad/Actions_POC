...
import { SmartrAnimationCurves, SmartrAnimationDurations } from 'app/shared/animations/defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${SmartrAnimationDurations.entering} ${SmartrAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${SmartrAnimationDurations.exiting} ${SmartrAnimationCurves.acceleration}`
                }
            }
        )
    ]
